...
namespace spec\Samurai\Samurai\Component\FileSystem\Finder;
...
class FinderSpec extends PHPSpecContext
{
    ...
    {
        $files = $this->path($this->fixtures_dir)->recursive()->name('file1.txt')->find();
        $files_array = $files->toArray();
        $files_array->shouldHaveCount(3);
        $files_array->shouldHaveValue('Fixtures/file1.txt');
        $files_array->shouldHaveValue('Fixtures/sub1/file1.txt');
    ...
    public function it_searches_recursive()
    {
        $files = $this->path($this->fixtures_dir)->recursive()->find();
        $files_array = $files->toArray();
